...
class ConfigManager:
    ...
    def _save_to_env(self, config: AppConfig) -> bool:
        """Save configuration to .env file (not implemented - use dotenv manually)."""
        logger.warning("Saving to .env file not implemented. Please edit .env manually.")
        return False
    ...
    def get_config_info(self) -> Dict[str, Any]:
        ...
        if self.current_config:
            ...
            for key in ["openai_api_key", "anthropic_api_key", "semantic_scholar_api_key"]:
