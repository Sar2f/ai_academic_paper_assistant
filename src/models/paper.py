...
class Paper:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "authors": [
                {"name": author.name, "author_id": author.author_id, "url": author.url} for author in self.authors
            ],
            "year": self.year,
    ...
    def from_semantic_scholar(cls, data: dict) -> "Paper":
        ...
        for author_data in data.get("authors", []):
            authors.append(
                Author(
                    name=author_data.get("name", ""), author_id=author_data.get("authorId"), url=author_data.get("url")
                )
            )
